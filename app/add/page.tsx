    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#0a0a12' }}>
      ...
      <main style={{ maxWidth: '760px', margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        {errors.length > 0 && (
          ...
          >
            {errors.map((e) => (
              <p key={e} style={{ color: '#fca5a5', fontSize: '0.875rem' }}>
                • {e}
              </p>
            ))}
          </div>
          ...
          {cards.map((card, i) => (
            ...
            >
              <div
                style={{
                  display: 'grid',
                  gridTemplateColumns: '1fr 160px 80px 90px auto',
                  gap: '10px',
                  alignItems: 'end',
                }}
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Npr. Blue-Eyes White Dragon"
                    style={inputStyle}
                  />
                </div>
                {/* Rarity */}
                <div>
                  ...
                  <select
                    value={card.rarity}
                    onChange={(e) => updateCard(i, 'rarity', e.target.value as Rarity)}
                    style={{ ...inputStyle, color: RARITY_COLORS[card.rarity] }}
                  >
                    {RARITIES.map((r) => (
                      <option key={r} value={r} style={{ color: RARITY_COLORS[r], backgroundColor: '#12121e' }}>
                        {r}
                      </option>
                    ))}
                  </select>
                ...
                <div>
                  ...
                  <input
                    ...
                    min={1}
                    value={card.quantity}
                    onChange={(e) => updateCard(i, 'quantity', Number(e.target.value))}
                    style={inputStyle}
                  />
                </div>
                {/* Price */}
                <div>
                  ...
                  <input
                    ...
                    step={0.1}
                    value={card.price}
                    onChange={(e) => updateCard(i, 'price', Number(e.target.value))}
                    style={inputStyle}
                  />
                </div>
                {/* Remove */}
                <div style={{ paddingBottom: '2px' }}>
                  <button
                    ...
                    style={{
                      ...
                      color: cards.length === 1 ? '#334155' : '#f87171',
                      border: 'none',
                      borderRadius: '6px',
        ...
        >
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
              ...
              <span style={{ color: '#f59e0b', fontWeight: 700, fontSize: '1.4rem' }}>
